...
\begin{longtable}{|p{4.5cm}|p{10cm}|}
	\hline
	\textbf{Mã Use case} & UC-UpdateInformation \\
	\hline
	\textbf{Tên Use case} & Update Personal Information \\
	\hline
	\textbf{Tác nhân} & Người dùng \\
	\hline
	...
	\hline
	\caption{Use Case: Update Personal Information} \label{tab:usecase-updateinformation} \\
\end{longtable}
