...
\begin{itemize}
	\item Người dùng nhấn "Logout".
	\item Client gửi gửi thông tin token người dùng qua API Gateway tới Controller.
	\item Nếu thông tin hợp lệ, gửi cho Service gửi truy vấn xóa token tới CSDL.
	\item Trả về kết quả thành công, Client chuyển đến giao diện đăng nhập.
\end{itemize}
\newpage
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figures/sequence-logout.png}
	\caption{Biểu đồ tuần tự cho chức năng đăng xuất}
	\end{figure}
...
\begin{itemize}
	\item Người dùng nhập email vào form, Client gửi qua API Gateway tới Service.
	\item Service tạo otp gửi tới email người dùng và gửi truy vấn tới CSDL để lưu otp.
	\item Nếu lưu vào CSDL thành công, Service trả về thành công, Client chuyển sang giao diện xác thực otp.
	\item Người dùng xác thực otp, Client chuyển otp cho Service.
	\item Nếu otp hợp lệ, Service trả về thành công, Client chuyển đến giao diện cài đặt mật khẩu mới. 
	\item Người dùng nhập mật khẩu mới vào form, Client gửi cho Service lưu vào CSDL và trả về thành công.
\end{itemize}
\newpage
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{figures/sequence-forgotpassword.png}
	\caption{Biểu đồ tuần tự cho chức năng quên mật khẩu}
	\end{figure}
